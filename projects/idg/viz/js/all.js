...
var svg = d3.select("#all-viz").append("svg")
    .attr("width", width)
    .attr("height", height)
    .attr("id", "all-canvas")
    .attr("class", "area");
...
/*var chart = d3.select("#all-chart-div").append("svg")
        .attr("height", chart_height)
        .attr("width", chart_width)
        .attr("id", "all-chart-canvas");*/
...
function calc_pressure() {
    ...
    var r = 0.0821;
    var t = temps[$("#speed").val()-1]; console.log(t);
    var v = vols[$("#volume").val()-1]; console.log(v);
    var n = masses[$("#mass").val()-1]; console.log(n);
